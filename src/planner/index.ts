...
const run = async () => {
  // await drawPlannerGraph(); // Uncomment to draw graph on run
...
run().catch((error) => {
  console.error("Error running the planner agent:", error);
