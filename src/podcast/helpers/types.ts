...
export const outputSchema = z.object({
  ...
  feedback: z.string().describe("Feedback on the coverage check"),
});
...
export const introSectionSchema = z
  ...
  .describe("Structure for the podcast introduction section.");

export const mainSegmentSchema = z
  .object({
  ...
  .describe("Structure for a main discussion segment of the podcast.");
...
export const summarySectionSchema = z
  ...
  .describe("Structure for the podcast summary section.");
...
export const outroSectionSchema = z
  ...
  .describe("Structure for the podcast outro section.");
...
export const podcastOutlineSchema = z
  .object({
    ...
    mainSegments: z
      ...
      .describe("An array of the main discussion segments."),
